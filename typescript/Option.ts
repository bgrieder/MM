...
export abstract class Option<A> extends Seq<A> {
     ...
     */
    abstract equals( that: Seq<A> ): boolean
    ...
    // Necessary to keep scala.Option from being implicitly converted to scala.collection.Seq in for comprehensions.
