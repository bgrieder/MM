...
var Option = (function (_super) {
    ...
    Option.prototype.collect = function (filter) {
        var _this = this;
        return function (mapper) { return _this.isEmpty ? _this : _this.filter(filter).map(mapper); };
    };
    ...
    Option.prototype.flatMap = function (f) {
        return this.isEmpty ? this : _super.prototype.flatMap.call(this, f);
    };
    Option.prototype.flatten = function () {
        return this.isEmpty ? this : _super.prototype.flatten.call(this);
    };
    ...
    Option.prototype.map = function (f) {
        return this.isEmpty ? this : _super.prototype.map.call(this, f);
    };
    // max: A
...
var Some = (function (_super) {
    ...
    Some.from = function (value) {
        return new Some([value]);
    };
    Some.prototype.equals = function (that) {
        if (that instanceof Some) {
            return Utils_1.eq(this.get, that.get);
        }
        return false;
    };
...
var None = (function (_super) {
    ...
    None.prototype.equals = function (that) {
...
function option(value) {
    return (typeof value === 'undefined' || value === null) ? this : some(value);
}
exports.option = option;
